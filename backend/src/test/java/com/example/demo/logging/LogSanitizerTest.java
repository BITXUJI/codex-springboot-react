...
class LogSanitizerTest {
    ...
    void sanitizeBodyMasksJsonFields() {
        ...
        Assertions.assertEquals("{\"password\":\"****\",\"token\":\"****\"}", sanitized,
    ...
    void sanitizeBodyMasksFormFields() {
        ...
        Assertions.assertEquals("token=****&value=1&password=****", sanitized,
                "Form sensitive fields should be masked");
    }
    ...
    void sanitizeBodyMasksVendorJsonFields() {
        ...
        Assertions.assertEquals("{\"token\":\"****\"}", sanitized,
                "Vendor JSON sensitive fields should be masked");
    }
    ...
    void sanitizeBodyKeepsNull() {
        Assertions.assertNull(LogSanitizer.sanitizeBody(null, JSON_CONTENT),
                "Null bodies should remain null");
    }
    ...
    void sanitizeBodyKeepsBlank() {
        Assertions.assertEquals(" ", LogSanitizer.sanitizeBody(" ", JSON_CONTENT),
                "Blank bodies should remain unchanged");
    }
    ...
    void sanitizeBodyKeepsUnknownType() {
        ...
        Assertions.assertEquals(body, LogSanitizer.sanitizeBody(body, TEXT_CONTENT),
