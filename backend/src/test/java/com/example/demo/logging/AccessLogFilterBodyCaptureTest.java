...
class AccessLogFilterBodyCaptureTest {
  ...
  void captureBodyEmptyIsNotOmitted() {
    ...
    Assertions.assertEquals(
        Boolean.FALSE, emptyCapture.omitted(), "Empty bodies should not be marked omitted");
  }
  ...
  void captureBodyBinaryIsOmitted() {
    ...
    final AccessLogFilter.BodyCapture binaryCapture = AccessLogFilter.captureBody(binary, CT_OCTET);

    Assertions.assertEquals(
        Boolean.TRUE, binaryCapture.omitted(), "Binary bodies should be marked omitted");
  }
  ...
  void captureBodyLongPayloadIsTruncated() {
    ...
    Assertions.assertEquals(
        Boolean.TRUE, bigCapture.truncated(), "Large bodies should be truncated");
  }
  ...
  void captureBodySmallPayloadIsNotTruncated() {
    ...
    Assertions.assertEquals(
        Boolean.FALSE, smallCapture.truncated(), "Small bodies should not be truncated");
  }
  ...
  void captureBodyNullPayloadIsNotOmitted() {
    ...
    Assertions.assertEquals(
        Boolean.FALSE, nullCapture.omitted(), "Null bodies should not be marked omitted");
  }
}
