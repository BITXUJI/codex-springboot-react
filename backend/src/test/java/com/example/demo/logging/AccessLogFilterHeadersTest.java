...
class AccessLogFilterHeadersTest {
    ...
    void sanitizeRequestHeadersHandlesNullNames() {
        final HttpServletRequest noHeaders = new MockHttpServletRequest(METHOD_GET, PATH_API) {
            @Override
    ...
    void sanitizeRequestHeadersHandlesNullValues() {
        final HttpServletRequest nullValues = new MockHttpServletRequest(METHOD_GET, PATH_API) {
            @Override
            public Enumeration<String> getHeaderNames() {
    ...
    void sanitizeResponseHeadersHandlesNullValues() {
        final HttpServletResponse nullResponse = new MockHttpServletResponse() {
            @Override
