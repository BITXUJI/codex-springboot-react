...
class LogSanitizerHeaderTest {
  ...
  void maskHeaderValueMasksApiKey() {
    Assertions.assertEquals(
        "****",
        LogSanitizer.maskHeaderValue(HEADER_API_KEY, VALUE_TOKEN),
  ...
  void maskHeaderValueLeavesOtherHeaders() {
    Assertions.assertEquals(
        VALUE_TEXT,
        LogSanitizer.maskHeaderValue(HEADER_OTHER, VALUE_TEXT),
  ...
  void maskHeaderValueHandlesNullHeaderName() {
    Assertions.assertEquals(
        VALUE_TEXT,
        LogSanitizer.maskHeaderValue(null, VALUE_TEXT),
  ...
  void maskHeaderValueHandlesNullHeaderValue() {
    Assertions.assertNull(
        LogSanitizer.maskHeaderValue(HEADER_AUTH, null), "Null header values should remain null");
  }
}
