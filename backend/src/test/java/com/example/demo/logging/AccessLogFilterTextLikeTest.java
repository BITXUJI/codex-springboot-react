...
class AccessLogFilterTextLikeTest {
  ...
  void isTextLikeNullReturnsTrue() {
    Assertions.assertEquals(
        Boolean.TRUE,
        AccessLogFilter.isTextLike(null),
  ...
  void isTextLikeTextReturnsTrue() {
    Assertions.assertEquals(
        Boolean.TRUE,
        AccessLogFilter.isTextLike(CT_TEXT),
  ...
  void isTextLikeJsonReturnsTrue() {
    Assertions.assertEquals(
        Boolean.TRUE,
        AccessLogFilter.isTextLike(CT_JSON),
  ...
  void isTextLikeJsonVendorReturnsTrue() {
    Assertions.assertEquals(
        Boolean.TRUE,
        AccessLogFilter.isTextLike(CT_JSON_VENDOR),
  ...
  void isTextLikeXmlReturnsTrue() {
    Assertions.assertEquals(
        Boolean.TRUE,
        AccessLogFilter.isTextLike(CT_XML),
  ...
  void isTextLikeXmlVendorReturnsTrue() {
    Assertions.assertEquals(
        Boolean.TRUE,
        AccessLogFilter.isTextLike(CT_XML_VENDOR),
  ...
  void isTextLikeFormReturnsTrue() {
    Assertions.assertEquals(
        Boolean.TRUE,
        AccessLogFilter.isTextLike(CT_FORM),
  ...
  void isTextLikeBinaryReturnsFalse() {
    Assertions.assertEquals(
        Boolean.FALSE,
        AccessLogFilter.isTextLike(CT_OCTET),
